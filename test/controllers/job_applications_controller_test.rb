...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { job_posting_id: @job_application.job_posting_id, student: @job_application.student } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { job_posting_id: @job_application.job_posting_id, student: @job_application.student } }
