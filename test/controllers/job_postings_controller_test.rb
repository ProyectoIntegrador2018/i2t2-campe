...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post job_postings_url, params: { job_posting: { description: @job_posting.description, employment_type: @job_posting.employment_type, experience_required: @job_posting.experience_required, keywords: @job_posting.keywords, number_positions: @job_posting.number_positions, responsabilities: @job_posting.responsabilities, salary: @job_posting.salary, title: @job_posting.title } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { description: @job_posting.description, employment_type: @job_posting.employment_type, experience_required: @job_posting.experience_required, keywords: @job_posting.keywords, number_positions: @job_posting.number_positions, responsabilities: @job_posting.responsabilities, salary: @job_posting.salary, title: @job_posting.title } }
